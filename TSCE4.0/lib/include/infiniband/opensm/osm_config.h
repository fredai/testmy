...
#define HAVE_DEFAULT_NODENAME_MAP "/usr/etc/opensm/ib-node-name-map"

/* Define a default OpenSM config file */
#define HAVE_DEFAULT_OPENSM_CONFIG_FILE "/usr/etc/opensm/opensm.conf"

/* Define a Partition config file */
#define HAVE_DEFAULT_PARTITION_CONFIG_FILE "/usr/etc/opensm/partitions.conf"

/* Define a Prefix Routes config file */
#define HAVE_DEFAULT_PREFIX_ROUTES_FILE "/usr/etc/opensm/prefix-routes.conf"

/* Define a QOS policy config file */
#define HAVE_DEFAULT_QOS_POLICY_FILE "/usr/etc/opensm/qos-policy.conf"

/* Define OpenSM config directory */
#define OPENSM_CONFIG_DIR "/usr/etc/opensm"
